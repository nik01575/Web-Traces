...
var htmlRenderInto = function (t, e) {
  ...
  tplElementDoughnut = function (t, e) {
    ...
    for (
      S.setAttribute('xmlns:wt', 'http://www.example.com/web-tracker'),
  ...
  tplElementChartStatsDays = function (t) {
    ...
    o.setAttribute('xmlns:wt', 'http://www.example.com/web-tracker'),
  ...
  tplElementChartStatsDaynames = function (t) {
    ...
    m.setAttribute('xmlns:wt', 'http://www.example.com/webt-traces'),
